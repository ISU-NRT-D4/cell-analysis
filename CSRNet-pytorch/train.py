...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        prec1 = validate(val_list, model, criterion,writer)
...
def validate(val_list, model, criterion,writer):
    print('begin test')
    ...
    print(' * MAE {mae:.3f} '
          .format(mae=mae))
    writer.add_scalar('Loss/val', mae, i)
    return mae
...
if __name__ == '__main__':
    if os.path.exists("0model_best.pth.tar"):
        os.remove("0model_best.pth.tar")
    if os.path.exists("0checkpoint.pth.tar"):
        os.remove("0checkpoint.pth.tar")
    main()
